...
for month in months:
    ...
    data = pd.read_csv(f'market_data/returns_{train_start}_{train_end}.csv')
    future_data = pd.read_csv(f'market_data/returns_{test_start}_{test_end}.csv')
    ...
    equal_weighted_portfolio.to_csv(f'baseline_portfolios/equal_weighted_portfolio_{train_start}_{train_end}.csv', index=False)
    ...
    optimized_portfolio.to_csv(f'baseline_portfolios/optimized_portfolio_{train_start}_{train_end}.csv', index=False)
